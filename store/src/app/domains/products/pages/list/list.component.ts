  ...
  ngOnInit() {
    this.products.set([
      ...
      },
      {
        ...
        price: 55.99,
        description: 'Great for wearing in the spring and autumn, this cotton jacket has a casual style and is perfect for daily wear.',
        category: Category.MenSClothing,
      ...
      },
      {
        ...
        price: 15.99,
        description: 'The long-sleeve t-shirt is made of 100% cotton and is soft and comfortable to wear.',
        category: Category.MenSClothing,
        image: 'https://fakestoreapi.com/img/71YXzeOuslL._AC_UY879_.jpg',
        rating: { rate: 2.1, count: 50 },
      },
      {
        id: 5,
      ...
      },
      {
        ...
        price: 168,
        description: 'SOLID GOLD, Dainty gold ring with 14k solid gold and pave set diamonds.',
        category: Category.Jewelery,
